...
namespace Erdcsharp.UnitTests.Domain.Codec
{
    ...
    public class StructBinaryCodecTests
    {
        ...
        [Test]
        public void Decode_Complex_Value_From_Vm_With_Optional_Null_Arg()
        {
            var data = "AAAABEVHTEQAAAAAAAAAAAAAAAcjhvJvwQAAAAAAD01JTlRURVNULWJhYzEyNwAAAARUZXN0AAAAJnFzZGtxc2pkbGtxanNsZGtqc3FrbGRqcXNsa2Rqc3FkcXNkc3FkAQABAAAAZAEBAAAAZAAAAGQAAAAAAAAAMgEA";
            var bytes = Convert.FromBase64String(data);
